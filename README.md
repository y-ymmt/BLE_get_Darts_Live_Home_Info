...
| セグメントコード | エリア | 詳細 |
|---------------|--------|------|
| 0x14 - 0x27 | トリプル1-20 | 時計回り順 |
| 0x28 - 0x3b | ダブル20-5 | 時計回り順 |
| 0x3e - 0x50 | シングル1-19 | 時計回り順 |
| 0x51 | アウターブル | 25点 |
| 0x52 | インナーブル | 50点 |
| 0x54 | シングル20 | |
...
⚠️ **プレイヤー交代ボタン**: DARTSLIVE HOMEのプレイヤー交代ボタンを押すと、シングル20（0x54）と同じコードが送信されます。現在の実装では、プレイヤー交代と実際のシングル20への投擲を区別していないため、両方とも「シングル20」として記録されます
